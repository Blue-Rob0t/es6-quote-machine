...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RandomQuote = __webpack_require__(2);
	...
	ELEMENTS.ELEMENT_GENERATE_BUTTON.addEventListener('click', _RandomQuote2.default); // import js files here
	// ex:
	// import X from y
	// var x = new X();
	...
	ELEMENTS.ELEMENT_GENERATE_BUTTON_TWITTER.addEventListener('click', _Tweet2.default);
...
/***/ function(module, exports) {
	...
	var ELEMENT_QUOTE_AREA = exports.ELEMENT_QUOTE_AREA = document.querySelector("#quote-area");
	// quote author
	var ELEMENT_AUTHOR = exports.ELEMENT_AUTHOR = document.querySelector("#author");
	// #generate-button of html document
	var ELEMENT_GENERATE_BUTTON = exports.ELEMENT_GENERATE_BUTTON = document.querySelector("#generate");
	// #generate-button-twitter of html document
	var ELEMENT_GENERATE_BUTTON_TWITTER = exports.ELEMENT_GENERATE_BUTTON_TWITTER = document.querySelector("#generate-twitter");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChangeText = __webpack_require__(3);
	...
	function randomQuote() {
	  ...
	  (0, _jquery2.default)('#quote-area').fadeOut(function () {
	    ...
	    xhr.onload = function () {
	      ...
	      (0, _ChangeText2.default)(quoteData);
	    };

	    xhr.send();

	    // fade in quote-area here
	    (0, _jquery2.default)('#quote-area').fadeIn(1000);
	  });
	} // change functionality of api call
